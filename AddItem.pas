...
begin
  ...
  begin
    ShowMessage('Ошибка! Введите корректное название предмета.');
    exit;
  end;
  ...
  begin
    ShowMessage('Ошибка! Введите корректное название производителя.');
    exit;
  end;
  ...
  ShowMessage(Edit1.Text + ' успешно добавлен(а) на склад. Количество: ' +Edit2.Text+'шт.');
  Edit1.Clear;
  Edit2.Clear;
  Edit3.Clear;
  Edit4.Clear;
