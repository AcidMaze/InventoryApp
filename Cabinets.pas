...
begin
  ...
  Form10.Show;
  Form10.Caption := 'Редактирование '+CRDBGrid1.DataSource.DataSet.Fields.FieldByname('name').Value;
  Form4.Enabled := false;
end;
...
begin
  ...
  Form8.Caption := 'Добавление предметов в '+CRDBGrid1.DataSource.DataSet.Fields.FieldByname('name').Value;;
  Form8.Show;
  Form4.Enabled := false;
end;
...
begin
  ...
  userResponse := MessageDlg('Вы действительно хотите удалить предмет: ' +name+ ' №'+id+'?', mtConfirmation, [mbYes, mbNo], 0);
...
begin
  ...
  CRDBGrid2.Columns[1].Title.Caption := 'Название';
