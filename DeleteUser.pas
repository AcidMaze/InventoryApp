...
begin
  userResponse := MessageDlg('Вы действительно хотите удалить этого пользователя?', mtConfirmation, [mbYes, mbNo], 0);
...
begin
  ...
  CRDBGrid1.Columns[1].Title.Caption := 'Логин пользователя';
